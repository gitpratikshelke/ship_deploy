  ...
  return (
    <div className="relative min-h-screen bg-slate-950 flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-10">
        <div className="absolute top-1/3 right-1/3 w-96 h-96 bg-violet-500/10 rounded-full blur-3xl mix-blend-screen"></div>
        <div className="absolute bottom-1/3 left-1/3 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl mix-blend-screen"></div>
      </div>
      ...
      <div className="relative z-20 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-1">Start tracking shipments with ShipTracker</p>
        </div>
